...
Object.defineProperty(person, "country", {
    value: "Canada",
    writable: true,     // The property value can be changed
    enumerable: true,   // The property will show up in enumerations like for...in or Object.keys()
    configurable: true  // The property can be deleted or reconfigured
});
console.log(person);
...
// Write your code here
console.log(`Property Names (Keys): ${Object.keys(student).join(', ')} \n
